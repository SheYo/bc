...
/* themes/custom/bethelks/templates/paragraph--all-aboard-bethel.html.twig */
class __TwigTemplate_c5a62c42fd83291e1d3cf46814a81ca4e484d55b4e8d9174026253c6593f7c12 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        $filters = array("render" => 44, "clean_class" => 127, "merge" => 135);
        $functions = array("attach_library" => 40);

        try {
            $this->env->getExtension('sandbox')->checkSecurity(
                array('if', 'set'),
                array('render', 'clean_class', 'merge'),
...
";
        // line 145
        echo "<div class=\"modal fade bd-example-modal-lg\" id=\"all-aboard-viewbox\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"all-aboard-viewbox-label\" aria-hidden=\"true\">
  <div class=\"modal-dialog modal-lg\">
    <div class=\"modal-content\">
      <div class=\"modal-header\">
        <h5 style=\"padding:0;margin:0;\">View Video</h5>
        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">
          <span aria-hidden=\"true\">&times;</span>
        </button>
      </div>
      <div style=\"padding-bottom:15px;\" class=\"modal-body\"></div>
    </div>
  </div>
</div>
...
<div";
        ...
        echo ">
    <div class=\"all-aboard-top\">
      <h2>All Aboard Bethel</h2>
      <p>See what comes with a Bethel education. All Aboard Bethel is a video gallery that examines various aspects of the Bethel College experience.</p>
    </div>
</div>

<div class=\"container-fluid all-aboard-controls\">
  <div class=\"row\">
    <div class=\"col d-flex align-items-center justify-content-center\">
      <button class=\"active-filter\" data-filter=\"*\">All</button>
    </div>
    <div class=\"col d-flex align-items-center justify-content-center\">
      <button data-filter=\".ab-filter-introduction\">Introduction</button>
    </div>
    <div class=\"col d-flex align-items-center justify-content-center\">
      <button data-filter=\".ab-filter-admissions\">Admissions</button>
    </div>
    <div class=\"col d-flex align-items-center justify-content-center\">
      <button data-filter=\".ab-filter-financial-aid\">Financial Aid</button>
    </div>
    <div class=\"col d-flex align-items-center justify-content-center\">
      <button data-filter=\".ab-filter-student-experience\">Student Experience</button>
    </div>
    <div class=\"col d-flex align-items-center justify-content-center\">
      <button data-filter=\".ab-filter-careers\">Careers</button>
    </div>
  </div>
</div>

<div class=\"all-aboard-content container-fluid\">
  <div class=\"row\">
    <!-- <div class=\"col-12 col-md-6 col-lg-4 col-xl-3 embed-responsive embed-responsive-16by9 all-aboard-video ab-filter-introduction\">
...
";
    ...
    {
        return "themes/custom/bethelks/templates/paragraph--all-aboard-bethel.html.twig";
    }
...
<div class=\"modal fade bd-example-modal-lg\" id=\"all-aboard-viewbox\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"all-aboard-viewbox-label\" aria-hidden=\"true\">
  <div class=\"modal-dialog modal-lg\">
    <div class=\"modal-content\">
      <div class=\"modal-header\">
        <h5 style=\"padding:0;margin:0;\">View Video</h5>
