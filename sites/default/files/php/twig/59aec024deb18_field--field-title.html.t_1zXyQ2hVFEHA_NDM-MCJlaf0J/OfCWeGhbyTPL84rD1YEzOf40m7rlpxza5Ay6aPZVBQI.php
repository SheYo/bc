...
/* themes/custom/bethelks/templates/bethelks_field/field--field-title.html.twig */
class __TwigTemplate_0fa3b0afb2dbc398b71f83773b71156c19bd2c19252ac93d57e3199b81072b47 extends Twig_Template
{
...
";
    ...
    {
        return "themes/custom/bethelks/templates/bethelks_field/field--field-title.html.twig";
    }
...
{% if label_hidden %}
  ...
  {% else %}
    {% for item in items %}
      <div{{ attributes }}><h2>{{ item.content }}</h2></div>
    {% endfor %}
  {% endif %}
{% else %}
  <div{{ attributes }}>
