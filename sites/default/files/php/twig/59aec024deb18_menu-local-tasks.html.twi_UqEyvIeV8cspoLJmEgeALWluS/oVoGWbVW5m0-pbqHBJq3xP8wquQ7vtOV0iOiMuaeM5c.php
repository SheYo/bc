...
/* themes/custom/bethelks/templates/bethelks_navigation/menu-local-tasks.html.twig */
class __TwigTemplate_936510f40bf9e7a3556776b24a6f437dd426fbf37a7e64293d62dc6c6c70ef94 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if ((isset($context["primary"]) ? $context["primary"] : null)) {
            ...
            echo "</h2>
  <ul class=\"menu-local-tasks-list\">";
            // line 16
...
";
    ...
    {
        return "themes/custom/bethelks/templates/bethelks_navigation/menu-local-tasks.html.twig";
    }
...
{% if primary %}
  ...
  <ul class=\"menu-local-tasks-list\">{{ primary }}</ul>
{% endif %}
{% if secondary %}
  <h2 class=\"visually-hidden\">{{ 'Secondary tabs'|t }}</h2>
  <ul class=\"menu-local-tasks-list\">{{ secondary }}</ul>
{% endif %}
";
    }
}
